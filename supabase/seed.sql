...
values
  ...
  ('gfo_or_chl38', 'ГФО / декл. чл. 38, ал. 9, т. 2 ЗСч (при липса на дейност)', 'recurring',
  ...
  ('consolidated_reports', 'Консолидирани годишни отчети (ако е приложимо)', 'recurring',
    '{"type":"fixed_date","month":9,"day":30,"note":"да се потвърди — може да важи само за консолидирани"}', false, false, null);
...
from (values
  ...
  ('chl61r', 'Годишна декл. чл. 61р, ал. 5 ЗМДТ', 'activity', '{"type":"fixed_date","month":1,"day":31,"note":"варира по община 30/31 януари"}', false)
