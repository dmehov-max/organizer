...
- 6 Edge Functions на живо (виж `supabase/README.md` за реалните им
...
- `upload.html` — отделна публична страница за клиенти (без логин):
  ...
  клиента" в досието му), пуска документи там, те се появяват в
  таб "Входящи документи" за счетоводителя
